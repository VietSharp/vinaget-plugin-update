...
*/ 
  public function Login($user, $pass){
		...
		$lt = $this->lib->cut_str($data,'"lt" value="', '" />');	
		$data = $this->lib->curl("https://id.vnn.vn/login;jsessionid={$jsid}?service=http%3A%2F%2Fshare.vnn.vn%2Flogin.php%3Fdo%3Dlogin%26url%3Dhttp%253A%252F%252Fshare.vnn.vn%252F", $cookies, "username={$user}&password={$pass}&lt={$lt}&_eventId=submit&submit=%C4%90%C4%83ng+nh%E1%BA%ADp");
