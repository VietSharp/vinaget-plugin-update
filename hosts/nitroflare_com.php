...
class dl_nitroflare_com extends Download {
	...
	public function Leech($url) {
		...
		if((stristr($data, "This file has been removed due")) || (stristr($data, "File doesn't exist")))  $this->error("dead", true, false, 2);
		elseif((stristr($data, "This download exceeds the daily download limit.")))  $this->error("LimitAcc", true, false, 2);
