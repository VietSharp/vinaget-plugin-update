...
class dl_1fichier_com extends Download {
	...
	public function CheckAcc($cookie) {
		...
		if (stristr($data, 'Your Premium offer subscription is valid until')) return array(true, "Premium Until: ".$this->lib->cut_str($data, "until <span style=\"font-weight:bold\">","</span>"));
