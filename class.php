...

{
	...
	function set_config(){
		...
		$this->zlink = $this->config['ziplink_ads'];
		$this->api_ads1 = $this->config['api_ads1'];
		$this->api_ads2 = $this->config['api_ads2'];
		$this->api_ads3 = $this->config['api_ads3'];
		$this->tinyurl_each_ziplink = $this->config['tinyurl_each_ziplink'];
...
{ 
	...
	{	
		...
		// #########Begin short link ############
		if (empty($this->zlink) == true && empty($link) == false && empty($this->tinyurl) == true) {
...

{
	...
	{
		if (strpos($url, "4sh7777777777ared.com")) $site = "4S";
		elseif (strpos($url, "mega.777777777777777777co.nz"))   $site = "MEGA";
		else {
