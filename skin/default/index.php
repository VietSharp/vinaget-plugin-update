						...
						<tr><td valign="top">
							<table border="0" cellpadding="0" cellspacing="0">
								<tr><td width="140" height="100%">
									...
									<div class="cell-plugin">
										<?php printf($obj->lang['plugins']); ?>
									</div>
									<?php } ?>
								</td></tr>
								<tr><td>
								...
								<tr><td height="100%" style="padding-bottom:3px;">
									<?php if ($obj->hide_plugins_col == false) { ?>
									<div dir="rtl" align="left" style="overflow-y:scroll; height:150px; padding-left:10px;">
									<?php
									...
									<?php } ?>
									<div class="cell-plugin"><?php printf($obj->lang['premium']); ?></a></div>
									<table border="0">
							...
							<form action="javascript:get(document.getElementById('linkform'));" name="linkform" id="linkform">
								...
								<?php if($obj->isadmin()){
									...
									if($obj->last_version > $obj->current_version2)
										echo '<br><font color="#dbac58"><b>'.sprintf($obj->lang['update1']).'</b> - <a href="https://raw.githubusercontent.com/lethanhtuan2897/vinaget-plugin-update/master/vng31.r'.$obj->last_version.'.zip">'.sprintf($obj->lang['update2'],$obj->last_version).'</a></font>';
								}
								?>
